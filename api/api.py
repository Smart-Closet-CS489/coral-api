...
app.add_url_rule('/models/<model_name>/training-session', 'post_training_session', post_training_session, methods=['POST'])
app.add_url_rule('/models/<model_name>/training-session', 'get_training_session', get_training_session, methods=['GET'])
