...
3. Updating existing models using transfer learning (with a specified learning rate)
4. Performing inferences on existing models

Please see docs/ENDPOINTS.md for a detailed description and use cases for each endpoint
